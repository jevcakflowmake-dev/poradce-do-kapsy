...
export default async function ClientChatPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20 py-10 md:py-14">
      ...
      <div className="flex flex-col h-[calc(100vh-320px)] min-h-[500px] bg-[#FDFCF8] rounded-none border border-[#E4DFD2] overflow-hidden shadow-[0_10px_30px_-10px_rgba(22,36,89,0.1)]">
        <div
        ...
        >
          ...
          />
          <div
            className="relative z-10 w-11 h-11 rounded-none flex items-center justify-center text-sm font-bold text-white"
