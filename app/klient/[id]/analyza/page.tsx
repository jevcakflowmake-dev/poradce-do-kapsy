...
const sections = [
  ...
  {
    id: 'housing', title: 'Bydlení', icon: Home, color: 'from-[#009EE2] to-[#0088c6]',
    questions: [
  ...
  {
    id: 'children', title: 'Děti', icon: Baby, color: 'from-[#009EE2] to-[#0088c6]',
    questions: [
  ...
  {
    id: 'property', title: 'Pojištění majetku', icon: Building2, color: 'from-[#009EE2] to-[#0088c6]',
    questions: [
          ...
          return (
            ...
            >
              <button onClick={() => toggleSection(section.id)} className="w-full flex items-center gap-4 p-5 md:p-6 text-left">
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    <div className="w-28 h-1 bg-[#E8E9EE] rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${progress}%`, background: 'linear-gradient(90deg, #009EE2, #0088c6)' }}
                      />
                    </div>
                ...
                {isExpanded ? <ChevronUp className="w-5 h-5 text-[#818EAF] flex-shrink-0" /> : <ChevronDown className="w-5 h-5 text-[#818EAF] flex-shrink-0" />}
              </button>
              <AnimatePresence>
                {isExpanded && (
                    ...
                    <div className="p-5 md:p-7 space-y-5">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <span className="text-sm text-[#818EAF] group-hover:text-[#162459]">Klikněte pro nahrání PDF nebo fotky</span>
                        </button>
                        {sectionFiles.length > 0 && (
                          <div className="mt-2.5 space-y-1.5">
                            {sectionFiles.map(f => (
                              <div key={f.name} className="flex items-center gap-2 bg-[#f8f9fc] rounded-xl px-3 py-2.5 text-sm border border-[#E8E9EE]">
                                ...
                                <button onClick={() => removeFile(f.name)} className="text-[#818EAF] hover:text-[#c2410c]"><X className="w-4 h-4" /></button>
                              </div>
                            ))}
                          </div>
                        )}
