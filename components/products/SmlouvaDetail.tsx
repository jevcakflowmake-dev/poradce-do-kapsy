...
import { krytiSmlouvy, spaydRetezec, type ObsahSmlouvy } from '@/lib/smlouvy'
...
export default function SmlouvaDetail({
  ...
  // Z varianty i ručně zadaná smlouva – obojí stejnými kartami jako v plánu.
  const kryti = krytiSmlouvy(smlouva)
  ...
  return (
    <div className="mt-4 pt-4 border-t border-line space-y-5">
      ...
      <KrytiPojistky castky={kryti.castky} volby={kryti.volby} titulek="Co máte sjednané" zvyraznit />
