...
export default function Step4Risk({
  ...
  return (
    <div className="bg-[#FDFCF8] rounded-none border border-[#E4DFD2] p-6 md:p-8">
      ...
      <p className="text-[#66708C] text-sm mt-2 mb-7">
        ...
        {OPTIONS.map((opt) => {
          ...
          return (
            <button
              ...
              className="w-full p-4 rounded-none text-left transition-all border"
              style={
                selected
                  ? {
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-[#66708C] mt-1">{opt.desc}</div>
                </div>
