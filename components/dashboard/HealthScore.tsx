...
export default function HealthScore({ score }: { score: number }) {
  ...
  return (
    <div className="rounded-none p-5 flex items-center gap-5 border" style={{ background: bgColor, borderColor: ringColor + '30' }}>
      ...
      <div>
        ...
        <div className="text-sm text-[#66708C] mt-0.5">Skóre finančního zdraví</div>
        <div className="text-xs text-[#8B93A8] mt-1">{sublabel}</div>
      </div>
    </div>
  )
}
