      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-lg bg-[#FDFCF8] rounded-none border border-[#E4DFD2] shadow-2xl overflow-hidden"
          ...
          >
            ...
            <button
              type="button"
              onClick={onClose}
              className="absolute top-5 right-5 w-8 h-8 rounded-full bg-[#F6F4EE] hover:bg-[#E4DFD2] flex items-center justify-center text-[#66708C] hover:text-[#162459] transition-all"
              aria-label="Zavřít"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <form onSubmit={onSubmit} className="p-7 md:p-8">
              <p className="text-[11px] tracking-[0.25em] uppercase text-[#66708C] mb-2">
                Dotaz · {sectionLabel}
              </p>
              <h2
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-none border border-[#E4DFD2] bg-[#F6F4EE] text-[#162459] text-[14px] placeholder:text-[#66708C]/70 focus:outline-none focus:border-[#009EE2] focus:ring-4 focus:ring-[#009EE2]/10 transition-all resize-none leading-relaxed"
                maxLength={500}
              />
              <div className="flex items-center justify-between mt-2 text-[11px] text-[#66708C]">
              ...
              <div className="flex items-center justify-end gap-2 mt-6">
                <button
                  ...
                  onClick={onClose}
                  disabled={sending}
                  className="px-5 py-2.5 rounded-none text-sm font-medium text-[#66708C] hover:text-[#162459] hover:bg-[#F6F4EE] transition-all"
                >
                  Zrušit
                </button>
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-none text-sm font-semibold text-white transition-all disabled:opacity-40 hover:shadow-lg hover:shadow-[#009EE2]/25 hover:-translate-y-0.5"
                  style={{ background: '#162459' }}
                >
                  {sending ? (
                    <>
