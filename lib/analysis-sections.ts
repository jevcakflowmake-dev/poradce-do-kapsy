...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    icon: Home,
    color: 'bg-navy',
    // Dvě větve podle `housing_situation`: kdo hypotéku má, dostane otázky na
    // ni; kdo ne, dostane otázky na plánovanou koupi. Nikdo nedostane obojí.
    questions: [
      ...
      },
      {
        ...
        help: 'Konec fixace je jediná chvíle, kdy jde sazba změnit bez sankce. Ozvu se vám včas.',
        showIf: { id: 'housing_situation', value: ['Ve vlastním s hypotékou'] },
      },
      {
        id: 'mortgage_bank',
      ...
      {
        id: 'plan_mortgage',
        label: 'Plánujete koupi nemovitosti na hypotéku?',
        type: 'select',
      ...
      },
      {
        ...
        label: 'Za jak dlouho plánujete koupi?',
        type: 'select',
      ...
      {
        id: 'property_type',
        label: 'Jakou nemovitost chcete koupit?',
        type: 'select',
        options: ['Byt', 'Dům', 'Pozemek', 'Jiné'],
        showIf: { id: 'plan_mortgage', value: ['Ano', 'Možná v budoucnu'] },
      },
      {
        id: 'mortgage_amount',
        label: 'Jakou výši úvěru budete potřebovat? (Kč)',
        type: 'number',
      ...
      {
        id: 'own_funds',
        label: 'Kolik máte našetřeno na vlastní zdroje? (Kč)',
        type: 'number',
        placeholder: '600 000',
        help: 'Banka obvykle chce 10–20 % z ceny. Podle toho se pozná, jestli koupě vyjde a kdy.',
        showIf: { id: 'plan_mortgage', value: ['Ano', 'Možná v budoucnu'] },
      },
      {
        id: 'mortgage_location',
        label: 'Kde chcete nemovitost koupit?',
        type: 'text',
